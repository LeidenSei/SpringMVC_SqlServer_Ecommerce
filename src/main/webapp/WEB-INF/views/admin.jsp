...
<!-- plugins:css -->
<link rel="stylesheet"
	href="${contextPath}/admin/vendors/feather/feather.css">
<link rel="stylesheet"
	href="${contextPath}/admin/vendors/ti-icons/css/themify-icons.css">
<link rel="stylesheet"
	href="${contextPath}/admin/vendors/css/vendor.bundle.base.css">
<!-- endinject -->
<!-- Plugin css for this page -->
<link rel="stylesheet"
	href="${contextPath}/admin/vendors/datatables.net-bs4/dataTables.bootstrap4.css">
<link rel="stylesheet"
	href="${contextPath}/admin/vendors/ti-icons/css/themify-icons.css">
...
<!-- inject:css -->
<link rel="stylesheet"
	href="${contextPath}/admin/css/vertical-layout-light/style.css">
<!-- endinject -->
...
<body>
	<div class="container-scroller">
		...
		<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
			<div
				...
				<a class="navbar-brand brand-logo mr-5" href="${contextPath}/admin/dashboard"><img
					src="${contextPath}/admin/images/logo.svg" class="mr-2" alt="logo" /></a>
				<a class="navbar-brand brand-logo-mini" href="index.html"><img
					src="${contextPath}/admin/images/logo-mini.svg" alt="logo" /></a>
			</div>
			<div
				...
				<ul class="navbar-nav navbar-nav-right">
					...
					<li class="nav-item nav-profile dropdown"><a
						...
						<div class="dropdown-menu dropdown-menu-right navbar-dropdown"
							aria-labelledby="profileDropdown"> <a class="dropdown-item" > <i
								class="text-primary"></i> Xin chào admin
							</a>
							<a class="dropdown-item" href="${contextPath}/admin/thoat"> <i
		...
		<div class="container-fluid page-body-wrapper">
			...
			<nav class="sidebar sidebar-offcanvas" id="sidebar">
				<ul class="nav">
					<li class="nav-item"><a class="nav-link" href="${contextPath}/admin/dashboard">
					...
					<li class="nav-item"><a class="nav-link"
						...
						aria-controls="ui-basic"> <i class="icon-layout menu-icon"></i>
							<span class="menu-title">Danh mục</span> <i class="menu-arrow"></i>
					</a>
						<div class="collapse" id="ui-basic">
							<ul class="nav flex-column sub-menu">
								<li class="nav-item"><a class="nav-link" href="category">Danh
										sách danh mục</a></li>
								<li class="nav-item"><a class="nav-link" href="addcategory">Thêm
										danh mục</a></li>
							</ul>
						</div></li>
					<li class="nav-item"><a class="nav-link"
						...
						aria-controls="form-elements"> <i
							class="icon-columns menu-icon"></i> <span class="menu-title">Product</span>
							<i class="menu-arrow"></i>
					</a>
						<div class="collapse" id="form-elements">
							<ul class="nav flex-column sub-menu">
								<li class="nav-item"><a class="nav-link" href="listPro">List
										Product</a></li>
					...
					<li class="nav-item"><a class="nav-link"
						...
						aria-controls="charts"> <i class="icon-bar-graph menu-icon"></i>
							<span class="menu-title">Order</span> <i class="menu-arrow"></i>
					</a>
						<div class="collapse" id="charts">
							<ul class="nav flex-column sub-menu">
								<li class="nav-item"><a class="nav-link"
									href="${contextPath}/admin/listorder">Danh sách đơn hàng</a></li>
							</ul>
						</div></li>
					<li class="nav-item"><a class="nav-link"
	...
	<script src="${contextPath}/admin/vendors/chart.js/Chart.min.js"></script>
	<script
		src="${contextPath}/admin/vendors/datatables.net/jquery.dataTables.js"></script>
	<script
		src="${contextPath}/admin/vendors/datatables.net-bs4/dataTables.bootstrap4.js"></script>
	<script src="${contextPath}/admin/js/dataTables.select.min.js"></script>
	...
	<script src="${contextPath}/admin/js/dashboard.js"></script>
	<script src="${contextPath}/admin/js/Chart.roundedBarCharts.js"></script>
